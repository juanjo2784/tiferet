...
<nav class="nav color3" id="pp">
  ...
  <li>
    ...
    <li>
      <a class="nav-link" href="?a=Parashat" title="Link para acceso a Información de la Parashat"><span class="float-left">Parashat</span></a>
    </li>
    <li>
      <a class="nav-link" href="?a=article&p=2" title="Link para acceso a Información de las segulot recomendadas por los miembros de tiferet"><span class="float-left">Segulot</span></a>
    </li>
    <li>
